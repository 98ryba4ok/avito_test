...
- **TypeScript** — библиотека для построения интерфейсов  
- **Vite** — быстрый сборщик и dev-сервер  
- **Axios** — для запросов к backend API  
- **Framer Motion** — анимации элементов интерфейса  
- **Vitest** — для unit-тестов  
- **html2canvas & jsPDF** — экспорт страниц и графиков в PDF  
...
---
Реализован весь дополнительный функционал кроме progress bar
---
## Запуск проекта
